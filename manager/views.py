...
def admin_approve_doctor_view(request):
    # doctors waiting for approval by admin
...
# This is the Billing system which we convert to pdf 
import io
...
def render_to_pdf(template_src, context_dict):
    ...
    result = io.BytesIO()
    pdf = pisa.pisaDocument(io.BytesIO(html.encode("ISO-100")), result)
    if not pdf.err:
...
# This is the view function for the Appointments
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
